...
const WorkPage = () => {
  const [BikeRef, setRef] = useState(null);

  const [move, setMove] = useState(new gsap.timeline());
                ...
                <StyledBody>
                  <StyledTitle>
                    <p>
                      ...
                      &nbsp;is e-commerce platform with the world’s finest
                      cycling clothing I ever experienced. Our mission is to
                      make cycling the most popular sport in the world.
                    </p>
                  </StyledTitle>
                  <p>
                    Current goal as a tech team is to create new e-commerce
                    platform based on modern serverless approach. As a front end
                    developer I am responsible for:
                  </p>
                  <UL>
                    <li>
                      <p>
                        Working closely with designer and other talented
                        developers on building up new UI from scratch.
                      </p>
                    </li>
                    <Link
                      passHref
                      href="https://www.npmjs.com/package/@rapharacing/rapha-ui"
                    >
                      <StyledAnchor3>npm rapha-ui</StyledAnchor3>
                    </Link>
                    <li>
                      <p>
                        Creating GraphQL schemas and integrating our CMS
                        Contentful data with our Components via Apollo
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        Beside main project I have been working with third party
                        GTM agency to implement updates to our current data
                        tracking layer
                      </p>
                    </li>
                  </UL>
            ...
            <>
              ...
              >
                ...
                <StyledBody>
                  ...
                  <UL>
                    <li>
                      Drag the map or choose city to get live weather update for
                      current location
                    </li>
                    <li>
                      Integrating two APIs together: Mapbox and Openweathermap
                    </li>
                  ...
                  <UL>
                    <li>
                      Contentful Headless CMS integreted with Gatsby build
                    </li>
                  </UL>
                  <ButtonsWrap>
                    <form>
                      <Button
                        type="submit"
                        formAction="https://jakub-playground.vercel.app/"
                      >
                        View Demo
                      </Button>
                    </form>
                  ...
                  <UL>
                    ...
                    <li>
                      Very Simple App showing how easy is to integrate
                      serverless backend / Auth on the front end side
                    </li>
