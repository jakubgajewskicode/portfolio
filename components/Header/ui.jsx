...
export const TopBar = styled.div`
	...
	transform: ${({ topChanged }) => (topChanged === true ? `translate3d(-5px, 3px, 0) rotate(-45deg)` : `translate3d(0, 10px, 0)`)};
`;
...
export const BottomBar = styled.div`
	...
	transform: ${({ bottomChanged }) => (bottomChanged === true ? `translate3d(-5px, -3px, 0) rotate(45deg)` : `translate3d(0, 0px, 0)`)};
`;
